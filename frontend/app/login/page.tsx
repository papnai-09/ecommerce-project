...
export default function Login() {
  return (
    <AuthCard>
      <h2 className="text-3xl font-semibold text-center mb-8 text-blue-500">LOGIN</h2>
      ...
      <form className="space-y-4">
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <button className="w-[30%] bg-blue-500 text-white p-2 rounded-3xl text-md hover:scale-105 transition-transform duration-300 ">
            Login
          </button>
        </div>
